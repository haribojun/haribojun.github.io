...
- **KAIST Full-Stack LLM Project Course with Solar** (KAIST x Upstage, sponsored by ORACLE) 24.07.04~24.07.06
  - This program provides an in-depth look at the theoretical background and practical application of Large Language Models (LLM). Additionally, it provides insight into the development potential and utilization of LLM through the latest research trends and case studies.
